...
Restaurant.create(:name => 'Aunts et Uncles', :address => '1407 Nostrand Ave., Brooklyn, NY 11226', :phone_number => "2112950001", :cuisine => "Caribbean", :details => "Relaxed vegan eatery serving plant-based burgers, breakfast sandwiches & sides, plus cocktails.", :hours => "Mon–Sat 10:00 am–10:00 pm Sun 10:00 am–6:00 pm", :dress_code => "Casual Dress", :website => "http://www.auntsetuncles.com/", :dining_style => "Casual Dining")
...
Restaurant.create(:name => 'Bunna Café', :address => '1084 Flushing Ave, Brooklyn, NY 11237', :phone_number => "2102952222", :cuisine => "Ethiopian", :details => "The traditional way to eat Ethiopian food is to use the injera as a scoop – no utensils. Try it, it’s fun! If you are looking for unique, plant-based food, this is the place to go.", :hours => "11:00AM - 12:00AM", :dress_code => "Business Casual", :website => "http://bunnaethiopia.net/", :dining_style => "Casual Dining")
...
Restaurant.create(:name => 'Jasmine’s Caribbean Cuisine', :address => '371 W 46th St, New York, NY 10036', :phone_number => "2109645337", :cuisine => "Caribbean, Seafood, Vegetarian / Vegan", :details => "A gem on Restaurant Row, Jasmine’s Caribbean Cuisine provides an escape from the city through the senses with savory dishes and fruit-filled blends of cocktails inspired by islands throughout the Caribbean.", :hours => "Tue–Fri 4:00 pm–10:30 pm Sat 2:00 pm–11:30 pm Sun 2:00 pm–10:30 pm", :dress_code => "Business Casual", :website => "http://jasminescaribbeancuisine.com/", :dining_style => "Casual Dining")
...
Restaurant.create!(:name =>  "Kochi", :address =>  "652 10th Ave, New York, NY  10036", :phone_number => "2064787777", :cuisine =>  "Korean", :details =>  "Seasonal ingredients shine both on your tastebuds and on your plate in this cool, sleek venue!", :hours =>  "Daily 5:00PM - 12:00AM", :dress_code =>  "Business Casual", :website => "www.kochiny.com", :dining_style =>  "multicourse tasting menu")
