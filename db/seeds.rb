...
#start user id at 33 and start restaruant id at 221
Review.create(:user_id => 23, :restaurant_id => 191, :overall_rating => 5, :food_rating => 5, :ambiance_rating => 5, :value_rating => 4, :noise_level => 4, :body => "Oh! My! God! So good! Everything from the starters to the entrees to the desserts meshed perfectly with my flavor-profile. The decor was unique and incredible. 5 stars!" )
Review.create(:user_id => 24, :restaurant_id => 192, :overall_rating => 5, :food_rating=> 4, :ambiance_rating=> 1, :value_rating=> 5, :noise_level=> 1, :body=>"This is one of my favorite places. Everything from the starters to the entrees to the desserts meshed perfectly with my flavor-profile. I want to hire their decorator to furnish my apartment. I was happy to see how clean everything was. The waiter did an excellent job. This is definitely a spot I'll be frequenting.")
Review.create(:user_id => 25, :restaurant_id => 193, :overall_rating => 5, :food_rating=> 4, :ambiance_rating=> 1, :value_rating=> 5, :noise_level=> 1, :body=>"Best experience ever! I found the ambiance to be very charming. The desserts must be sprinkled with crack because I just craved for more and more. The food was flavorful, savory, and succulent. I was happy to see how clean everything was. I'd give more than 5 stars if I could!")
Review.create(:user_id => 26, :restaurant_id => 194, :overall_rating => 5, :food_rating=> 4, :ambiance_rating=> 1, :value_rating=> 5, :noise_level=> 1, :body=>"Oh my God! So yummy! Try out the huge selection of incredible appetizers. Everything was just so yummy. I would eat here every day if I could afford it!")
Review.create(:user_id => 27, :restaurant_id => 195, :overall_rating => 5, :food_rating=> 4, :ambiance_rating=> 1, :value_rating=> 5, :noise_level=> 1, :body=>"I've got a fetish for good food and this place gets me hot! Everything was just so yummy. Try out the huge selection of incredible appetizers. I was happy to see how clean everything was. This is definitely a spot I'll be frequenting.")
Review.create(:user_id => 28, :restaurant_id => 196, :overall_rating => 5, :food_rating=> 3, :ambiance_rating=> 1, :value_rating=> 5, :noise_level=> 1, :body=>"I stumbled on this undiscovered gem right in our neighboorhood. Everything from the starters to the entrees to the desserts meshed perfectly with my flavor-profile. Everything I tried was bursting with flavor. The decor was unique and incredible. They got a new customer for life!")
Review.create(:user_id => 29, :restaurant_id => 197, :overall_rating => 5, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 5, :noise_level=> 1, :body=>"Best experience ever! I found the ambiance to be very charming. The desserts must be sprinkled with crack because I just craved for more and more. The food was flavorful, savory, and succulent. I was happy to see how clean everything was. I'd give more than 5 stars if I could!")
Review.create(:user_id => 30, :restaurant_id => 198, :overall_rating => 5, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 4, :noise_level=> 2, :body=>"This is one of my favorite places. Everything was simply decadent. I found the ambiance to be very charming. 5 stars!")
Review.create(:user_id => 31, :restaurant_id => 199, :overall_rating => 5, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 4, :noise_level=> 2, :body=>"Yumm-o! Everything from the starters to the entrees to the desserts meshed perfectly with my flavor-profile. Everything was just so yummy. Easily earned their 5 stars!")
Review.create(:user_id => 32, :restaurant_id => 200, :overall_rating => 5, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 4, :noise_level=> 2, :body=>"I stumbled on this undiscovered gem right in our neighboorhood. Everything from the starters to the entrees to the desserts meshed perfectly with my flavor-profile. Everything I tried was bursting with flavor. The decor was unique and incredible. They got a new customer for life!")
Review.create(:user_id => 23, :restaurant_id => 201, :overall_rating => 5, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 4, :noise_level=> 2, :body=>"Oh my God! So yummy! Try out the huge selection of incredible appetizers. Everything was just so yummy. I would eat here every day if I could afford it!")
Review.create(:user_id => 24, :restaurant_id => 202, :overall_rating => 5, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 4, :noise_level=> 2, :body=>"This is one of my favorite places. Everything was simply decadent. I found the ambiance to be very charming. 5 stars!")
Review.create(:user_id => 25, :restaurant_id => 203, :overall_rating => 5, :food_rating=> 3, :ambiance_rating=> 3, :value_rating=> 4, :noise_level=> 3, :body=>"I've got a fetish for good food and this place gets me hot! Everything was just so yummy. Try out the huge selection of incredible appetizers. I was happy to see how clean everything was. This is definitely a spot I'll be frequenting.")
Review.create(:user_id => 26, :restaurant_id => 204, :overall_rating => 5, :food_rating=> 2, :ambiance_rating=> 3, :value_rating=> 3, :noise_level=> 3, :body=>"I stumbled on this undiscovered gem right in our neighboorhood. Everything from the starters to the entrees to the desserts meshed perfectly with my flavor-profile. Everything I tried was bursting with flavor. The decor was unique and incredible. They got a new customer for life!")
Review.create(:user_id => 27, :restaurant_id => 205, :overall_rating => 5, :food_rating=> 2, :ambiance_rating=> 3, :value_rating=> 3, :noise_level=> 3, :body=>"Best experience ever! I found the ambiance to be very charming. The desserts must be sprinkled with crack because I just craved for more and more. The food was flavorful, savory, and succulent. I was happy to see how clean everything was. I'd give more than 5 stars if I could!")
Review.create(:user_id => 28, :restaurant_id => 206, :overall_rating => 5, :food_rating=> 2, :ambiance_rating=> 3, :value_rating=> 3, :noise_level=> 3, :body=>"Yumm-o! Everything from the starters to the entrees to the desserts meshed perfectly with my flavor-profile. Everything was just so yummy. Easily earned their 5 stars!")
Review.create(:user_id => 29, :restaurant_id => 207, :overall_rating => 5, :food_rating=> 2, :ambiance_rating=> 3, :value_rating=> 3, :noise_level=> 3, :body=>"This is one of my favorite places. Everything was simply decadent. I found the ambiance to be very charming. 5 stars!")
Review.create(:user_id => 30, :restaurant_id => 208, :overall_rating => 5, :food_rating=> 1, :ambiance_rating=> 3, :value_rating=> 3, :noise_level=> 4, :body=>"I've got a fetish for good food and this place gets me hot! Everything was just so yummy. Try out the huge selection of incredible appetizers. I was happy to see how clean everything was. This is definitely a spot I'll be frequenting.")
Review.create(:user_id => 31, :restaurant_id => 209, :overall_rating => 5, :food_rating=> 1, :ambiance_rating=> 3, :value_rating=> 2, :noise_level=> 4, :body=>"Oh my God! So yummy! Try out the huge selection of incredible appetizers. Everything was just so yummy. I would eat here every day if I could afford it!")
Review.create(:user_id => 32, :restaurant_id => 210, :overall_rating => 5, :food_rating=> 1, :ambiance_rating=> 4, :value_rating=> 2, :noise_level=> 4, :body=>"Yumm-o! Everything from the starters to the entrees to the desserts meshed perfectly with my flavor-profile. Everything was just so yummy. Easily earned their 5 stars!")
Review.create(:user_id => 23, :restaurant_id => 211, :overall_rating => 5, :food_rating=> 1, :ambiance_rating=> 4, :value_rating=> 2, :noise_level=> 4, :body=>"I stumbled on this undiscovered gem right in our neighboorhood. Everything from the starters to the entrees to the desserts meshed perfectly with my flavor-profile. Everything I tried was bursting with flavor. The decor was unique and incredible. They got a new customer for life!")
Review.create(:user_id => 24, :restaurant_id => 212, :overall_rating => 5, :food_rating=> 1, :ambiance_rating=> 4, :value_rating=> 2, :noise_level=> 4, :body=>"I've got a fetish for good food and this place gets me hot! Everything was just so yummy. Try out the huge selection of incredible appetizers. I was happy to see how clean everything was. This is definitely a spot I'll be frequenting.")
Review.create(:user_id => 25, :restaurant_id => 213, :overall_rating => 5, :food_rating=> 5, :ambiance_rating=> 4, :value_rating=> 2, :noise_level=> 5, :body=>"Yumm-o! Everything from the starters to the entrees to the desserts meshed perfectly with my flavor-profile. Everything was just so yummy. Easily earned their 5 stars!")
Review.create(:user_id => 26, :restaurant_id => 214, :overall_rating => 5, :food_rating=> 5, :ambiance_rating=> 4, :value_rating=> 1, :noise_level=> 5, :body=>"Best experience ever! I found the ambiance to be very charming. The desserts must be sprinkled with crack because I just craved for more and more. The food was flavorful, savory, and succulent. I was happy to see how clean everything was. I'd give more than 5 stars if I could!")
Review.create(:user_id => 27, :restaurant_id => 215, :overall_rating => 5, :food_rating=> 5, :ambiance_rating=> 4, :value_rating=> 1, :noise_level=> 5, :body=>"This is one of my favorite places. Everything was simply decadent. I found the ambiance to be very charming. 5 stars!")
Review.create(:user_id => 28, :restaurant_id => 216, :overall_rating => 5, :food_rating=> 5, :ambiance_rating=> 5, :value_rating=> 1, :noise_level=> 5, :body=>"I've got a fetish for good food and this place gets me hot! Everything was just so yummy. Try out the huge selection of incredible appetizers. I was happy to see how clean everything was. This is definitely a spot I'll be frequenting.")
Review.create(:user_id => 29, :restaurant_id => 217, :overall_rating => 5, :food_rating=> 5, :ambiance_rating=> 5, :value_rating=> 1, :noise_level=> 5, :body=>"Oh my God! So yummy! Try out the huge selection of incredible appetizers. Everything was just so yummy. I would eat here every day if I could afford it!")
Review.create(:user_id => 30, :restaurant_id => 218, :overall_rating => 5, :food_rating=> 4, :ambiance_rating=> 5, :value_rating=> 1, :noise_level=> 5, :body=>"I stumbled on this undiscovered gem right in our neighboorhood. Everything from the starters to the entrees to the desserts meshed perfectly with my flavor-profile. Everything I tried was bursting with flavor. The decor was unique and incredible. They got a new customer for life!")
Review.create(:user_id => 31, :restaurant_id => 219, :overall_rating => 5, :food_rating=> 4, :ambiance_rating=> 5, :value_rating=> 2, :noise_level=> 1, :body=>"Oh my God! So yummy! Try out the huge selection of incredible appetizers. Everything was just so yummy. I would eat here every day if I could afford it!")
Review.create(:user_id => 32, :restaurant_id => 220, :overall_rating => 5, :food_rating=> 4, :ambiance_rating=> 5, :value_rating=> 2, :noise_level=> 1, :body=>"Best experience ever! I found the ambiance to be very charming. The desserts must be sprinkled with crack because I just craved for more and more. The food was flavorful, savory, and succulent. I was happy to see how clean everything was. I'd give more than 5 stars if I could!")

Review.create(:user_id => 23, :restaurant_id => 191, :overall_rating => 4, :food_rating => 5, :ambiance_rating => 5, :value_rating => 4, :noise_level => 4, :body => "Oh! My! God! So good! Everything from the starters to the entrees to the desserts meshed perfectly with my flavor-profile. The decor was unique and incredible. 5 stars!" )
Review.create(:user_id => 24, :restaurant_id => 192, :overall_rating => 4, :food_rating=> 4, :ambiance_rating=> 1, :value_rating=> 5, :noise_level=> 1, :body=>"Decent place. Everything I tried was bursting with flavor. The desserts must be sprinkled with crack because I just craved for more and more. There were a lot of interesting decorations on the walls. 4 stars of satisfaction.")
Review.create(:user_id => 25, :restaurant_id => 193, :overall_rating => 4, :food_rating=> 4, :ambiance_rating=> 1, :value_rating=> 5, :noise_level=> 1, :body=>"This place was nearby and I decided to check it out. Everything was mostly decadent. I was happy to see how clean everything was. There were a lot of interesting decorations on the walls. The waitress did an excellent job. I had a satisfactory experience and will have to try it again.")
Review.create(:user_id => 26, :restaurant_id => 194, :overall_rating => 4, :food_rating=> 4, :ambiance_rating=> 1, :value_rating=> 5, :noise_level=> 1, :body=>"This place had a lot of heart. Make sure to save room for dessert, because that was the best part of the meal! Everything was just so yummy. It failed to meet the 5-star experience because the wait to get in was so long.")
Review.create(:user_id => 27, :restaurant_id => 195, :overall_rating => 4, :food_rating=> 4, :ambiance_rating=> 1, :value_rating=> 5, :noise_level=> 1, :body=>"It was much better than I expected. There were a lot of interesting decorations on the walls. The waiter was prompt and polite. I found the entrees to be very agreeable to my personal flavor-profile. It could have been perfect, but the chairs were a little sticky.")
Review.create(:user_id => 28, :restaurant_id => 196, :overall_rating => 4, :food_rating=> 3, :ambiance_rating=> 1, :value_rating=> 5, :noise_level=> 1, :body=>"This place was nearby and I decided to check it out. Everything was mostly decadent. I was happy to see how clean everything was. There were a lot of interesting decorations on the walls. The waitress did an excellent job. I had a satisfactory experience and will have to try it again.")
Review.create(:user_id => 29, :restaurant_id => 197, :overall_rating => 4, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 5, :noise_level=> 1, :body=>"Decent place. Everything I tried was bursting with flavor. The desserts must be sprinkled with crack because I just craved for more and more. There were a lot of interesting decorations on the walls. 4 stars of satisfaction.")
Review.create(:user_id => 30, :restaurant_id => 198, :overall_rating => 4, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 4, :noise_level=> 2, :body=>"This place had a lot of heart. Everything was just so yummy. The waiter did an excellent job. Satisfactory experience, will come again.")
Review.create(:user_id => 31, :restaurant_id => 199, :overall_rating => 4, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 4, :noise_level=> 2, :body=>"I have been here several times before. Make sure to save room for dessert, because that was the best part of the meal! The waiter was prompt and polite. I found the entrees to be very agreeable to my personal flavor-profile. I had a satisfactory experience and will have to try it again.")
Review.create(:user_id => 32, :restaurant_id => 200, :overall_rating => 4, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 4, :noise_level=> 2, :body=>"It was much better than I expected. There were a lot of interesting decorations on the walls. The waiter was prompt and polite. I found the entrees to be very agreeable to my personal flavor-profile. It could have been perfect, but the chairs were a little sticky.")
Review.create(:user_id => 23, :restaurant_id => 201, :overall_rating => 4, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 4, :noise_level=> 2, :body=>"This place had a lot of heart. Make sure to save room for dessert, because that was the best part of the meal! Everything was just so yummy. It failed to meet the 5-star experience because the wait to get in was so long.")
Review.create(:user_id => 24, :restaurant_id => 202, :overall_rating => 4, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 4, :noise_level=> 2, :body=>"This place was nearby and I decided to check it out. Everything was mostly decadent. I was happy to see how clean everything was. There were a lot of interesting decorations on the walls. The waitress did an excellent job. I had a satisfactory experience and will have to try it again.")
Review.create(:user_id => 25, :restaurant_id => 203, :overall_rating => 4, :food_rating=> 3, :ambiance_rating=> 3, :value_rating=> 4, :noise_level=> 3, :body=>"Decent place. Everything I tried was bursting with flavor. The desserts must be sprinkled with crack because I just craved for more and more. There were a lot of interesting decorations on the walls. 4 stars of satisfaction.")
Review.create(:user_id => 26, :restaurant_id => 204, :overall_rating => 4, :food_rating=> 2, :ambiance_rating=> 3, :value_rating=> 3, :noise_level=> 3, :body=>"This place had a lot of heart. Everything was just so yummy. The waiter did an excellent job. Satisfactory experience, will come again.")
Review.create(:user_id => 27, :restaurant_id => 205, :overall_rating => 4, :food_rating=> 2, :ambiance_rating=> 3, :value_rating=> 3, :noise_level=> 3, :body=>"It was much better than I expected. There were a lot of interesting decorations on the walls. The waiter was prompt and polite. I found the entrees to be very agreeable to my personal flavor-profile. It could have been perfect, but the chairs were a little sticky.")
Review.create(:user_id => 28, :restaurant_id => 206, :overall_rating => 4, :food_rating=> 2, :ambiance_rating=> 3, :value_rating=> 3, :noise_level=> 3, :body=>"This place had a lot of heart. Make sure to save room for dessert, because that was the best part of the meal! Everything was just so yummy. It failed to meet the 5-star experience because the wait to get in was so long.")
Review.create(:user_id => 29, :restaurant_id => 207, :overall_rating => 4, :food_rating=> 2, :ambiance_rating=> 3, :value_rating=> 3, :noise_level=> 3, :body=>"This place was nearby and I decided to check it out. Everything was mostly decadent. I was happy to see how clean everything was. There were a lot of interesting decorations on the walls. The waitress did an excellent job. I had a satisfactory experience and will have to try it again.")
Review.create(:user_id => 30, :restaurant_id => 208, :overall_rating => 4, :food_rating=> 1, :ambiance_rating=> 3, :value_rating=> 3, :noise_level=> 4, :body=>"Decent place. Everything I tried was bursting with flavor. The desserts must be sprinkled with crack because I just craved for more and more. There were a lot of interesting decorations on the walls. 4 stars of satisfaction.")
Review.create(:user_id => 31, :restaurant_id => 209, :overall_rating => 4, :food_rating=> 1, :ambiance_rating=> 3, :value_rating=> 2, :noise_level=> 4, :body=>"This place had a lot of heart. Everything was just so yummy. The waiter did an excellent job. Satisfactory experience, will come again.")
Review.create(:user_id => 32, :restaurant_id => 210, :overall_rating => 4, :food_rating=> 1, :ambiance_rating=> 4, :value_rating=> 2, :noise_level=> 4, :body=>"It was much better than I expected. There were a lot of interesting decorations on the walls. The waiter was prompt and polite. I found the entrees to be very agreeable to my personal flavor-profile. It could have been perfect, but the chairs were a little sticky.")
Review.create(:user_id => 23, :restaurant_id => 211, :overall_rating => 4, :food_rating=> 1, :ambiance_rating=> 4, :value_rating=> 2, :noise_level=> 4, :body=>"This place had a lot of heart. Make sure to save room for dessert, because that was the best part of the meal! Everything was just so yummy. It failed to meet the 5-star experience because the wait to get in was so long.")
Review.create(:user_id => 24, :restaurant_id => 212, :overall_rating => 4, :food_rating=> 1, :ambiance_rating=> 4, :value_rating=> 2, :noise_level=> 4, :body=>"This place was nearby and I decided to check it out. Everything was mostly decadent. I was happy to see how clean everything was. There were a lot of interesting decorations on the walls. The waitress did an excellent job. I had a satisfactory experience and will have to try it again.")
Review.create(:user_id => 25, :restaurant_id => 213, :overall_rating => 4, :food_rating=> 5, :ambiance_rating=> 4, :value_rating=> 2, :noise_level=> 5, :body=>"Decent place. Everything I tried was bursting with flavor. The desserts must be sprinkled with crack because I just craved for more and more. There were a lot of interesting decorations on the walls. 4 stars of satisfaction.")
Review.create(:user_id => 26, :restaurant_id => 214, :overall_rating => 4, :food_rating=> 5, :ambiance_rating=> 4, :value_rating=> 1, :noise_level=> 5, :body=>"This place had a lot of heart. Everything was just so yummy. The waiter did an excellent job. Satisfactory experience, will come again.")
Review.create(:user_id => 27, :restaurant_id => 215, :overall_rating => 4, :food_rating=> 5, :ambiance_rating=> 4, :value_rating=> 1, :noise_level=> 5, :body=>"It was much better than I expected. There were a lot of interesting decorations on the walls. The waiter was prompt and polite. I found the entrees to be very agreeable to my personal flavor-profile. It could have been perfect, but the chairs were a little sticky.")
Review.create(:user_id => 28, :restaurant_id => 216, :overall_rating => 4, :food_rating=> 5, :ambiance_rating=> 5, :value_rating=> 1, :noise_level=> 5, :body=>"This place had a lot of heart. Make sure to save room for dessert, because that was the best part of the meal! Everything was just so yummy. It failed to meet the 5-star experience because the wait to get in was so long.")
Review.create(:user_id => 29, :restaurant_id => 217, :overall_rating => 4, :food_rating=> 5, :ambiance_rating=> 5, :value_rating=> 1, :noise_level=> 5, :body=>"This place was nearby and I decided to check it out. Everything was mostly decadent. I was happy to see how clean everything was. There were a lot of interesting decorations on the walls. The waitress did an excellent job. I had a satisfactory experience and will have to try it again.")
Review.create(:user_id => 30, :restaurant_id => 218, :overall_rating => 4, :food_rating=> 4, :ambiance_rating=> 5, :value_rating=> 1, :noise_level=> 5, :body=>"This place had a lot of heart. Everything was just so yummy. The waiter did an excellent job. Satisfactory experience, will come again.")
Review.create(:user_id => 31, :restaurant_id => 219, :overall_rating => 4, :food_rating=> 4, :ambiance_rating=> 5, :value_rating=> 2, :noise_level=> 1, :body=>"It was much better than I expected. There were a lot of interesting decorations on the walls. The waiter was prompt and polite. I found the entrees to be very agreeable to my personal flavor-profile. It could have been perfect, but the chairs were a little sticky.")
Review.create(:user_id => 32, :restaurant_id => 220, :overall_rating => 4, :food_rating=> 4, :ambiance_rating=> 5, :value_rating=> 2, :noise_level=> 1, :body=>"Decent place. Everything I tried was bursting with flavor. The desserts must be sprinkled with crack because I just craved for more and more. There were a lot of interesting decorations on the walls. 4 stars of satisfaction.")

Review.create(:user_id => 23, :restaurant_id => 191, :overall_rating => 3, :food_rating => 5, :ambiance_rating => 5, :value_rating => 4, :noise_level => 4, :body => "Oh! My! God! So good! Everything from the starters to the entrees to the desserts meshed perfectly with my flavor-profile. The decor was unique and incredible. 5 stars!" )
Review.create(:user_id => 24, :restaurant_id => 192, :overall_rating => 3, :food_rating=> 4, :ambiance_rating=> 1, :value_rating=> 5, :noise_level=> 1, :body=>"I'm torn about this place. The entree I had was sublime. The ambiance gives off an earthy feel-good vibe. Overall experience: 3 stars.")
Review.create(:user_id => 25, :restaurant_id => 193, :overall_rating => 3, :food_rating=> 4, :ambiance_rating=> 1, :value_rating=> 5, :noise_level=> 1, :body=>"This place had a lot of heart. I was not very pleased to find out that the coffee wasn't fair trade. The menu didn't match the one on their website. There were a lot of interesting decorations on the walls. Satisfactory experience, will come again.")
Review.create(:user_id => 26, :restaurant_id => 194, :overall_rating => 3, :food_rating=> 4, :ambiance_rating=> 1, :value_rating=> 5, :noise_level=> 1, :body=>"I had high hopes for this place. I felt the prices were too high given the quality of the food. The service wasn't that good and the waiter was clueless. Might be back. Time will tell.")
Review.create(:user_id => 27, :restaurant_id => 195, :overall_rating => 3, :food_rating=> 4, :ambiance_rating=> 1, :value_rating=> 5, :noise_level=> 1, :body=>"This place had a lot of heart. Some of my favorite dishes are no longer available. The entree I had was sublime. I had a satisfactory experience and will have to try it again.")
...
Review.create(:user_id => 29, :restaurant_id => 197, :overall_rating => 3, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 5, :noise_level=> 1, :body=>"This place had a lot of heart. I was not very pleased to find out that the coffee wasn't fair trade. The menu didn't match the one on their website. There were a lot of interesting decorations on the walls. Satisfactory experience, will come again.")
Review.create(:user_id => 30, :restaurant_id => 198, :overall_rating => 3, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 4, :noise_level=> 2, :body=>"I'm torn about this place. The entree I had was sublime. The ambiance gives off an earthy feel-good vibe. Overall experience: 3 stars.")
Review.create(:user_id => 31, :restaurant_id => 199, :overall_rating => 3, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 4, :noise_level=> 2, :body=>"I had high hopes for this place. I felt the prices were too high given the quality of the food. The service wasn't that good and the waiter was clueless. Might be back. Time will tell.")
Review.create(:user_id => 32, :restaurant_id => 200, :overall_rating => 3, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 4, :noise_level=> 2, :body=>"I have been here several times before. Some of my favorite dishes are no longer available. The menu didn't match the one on their website. The chicken was a little dry. I had a satisfactory experience and will have to try it again.")
Review.create(:user_id => 23, :restaurant_id => 201, :overall_rating => 3, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 4, :noise_level=> 2, :body=>"This place had a lot of heart. Some of my favorite dishes are no longer available. The entree I had was sublime. I had a satisfactory experience and will have to try it again.")
Review.create(:user_id => 24, :restaurant_id => 202, :overall_rating => 3, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 4, :noise_level=> 2, :body=>"I had high hopes for this place. I felt the prices were too high given the quality of the food. The service wasn't that good and the waiter was clueless. Might be back. Time will tell.")
Review.create(:user_id => 25, :restaurant_id => 203, :overall_rating => 3, :food_rating=> 3, :ambiance_rating=> 3, :value_rating=> 4, :noise_level=> 3, :body=>"I'm torn about this place. The entree I had was sublime. The ambiance gives off an earthy feel-good vibe. Overall experience: 3 stars.")
Review.create(:user_id => 26, :restaurant_id => 204, :overall_rating => 3, :food_rating=> 2, :ambiance_rating=> 3, :value_rating=> 3, :noise_level=> 3, :body=>"I have been here several times before. Some of my favorite dishes are no longer available. The menu didn't match the one on their website. The chicken was a little dry. I had a satisfactory experience and will have to try it again.")
Review.create(:user_id => 27, :restaurant_id => 205, :overall_rating => 3, :food_rating=> 2, :ambiance_rating=> 3, :value_rating=> 3, :noise_level=> 3, :body=>"This place had a lot of heart. I was not very pleased to find out that the coffee wasn't fair trade. The menu didn't match the one on their website. There were a lot of interesting decorations on the walls. Satisfactory experience, will come again.")
Review.create(:user_id => 28, :restaurant_id => 206, :overall_rating => 3, :food_rating=> 2, :ambiance_rating=> 3, :value_rating=> 3, :noise_level=> 3, :body=>"I had high hopes for this place. I felt the prices were too high given the quality of the food. The service wasn't that good and the waiter was clueless. Might be back. Time will tell.")
Review.create(:user_id => 29, :restaurant_id => 207, :overall_rating => 3, :food_rating=> 2, :ambiance_rating=> 3, :value_rating=> 3, :noise_level=> 3, :body=>"I have been here several times before. Some of my favorite dishes are no longer available. The menu didn't match the one on their website. The chicken was a little dry. I had a satisfactory experience and will have to try it again.")
Review.create(:user_id => 30, :restaurant_id => 208, :overall_rating => 3, :food_rating=> 1, :ambiance_rating=> 3, :value_rating=> 3, :noise_level=> 4, :body=>"This place had a lot of heart. Some of my favorite dishes are no longer available. The entree I had was sublime. I had a satisfactory experience and will have to try it again.")
Review.create(:user_id => 31, :restaurant_id => 209, :overall_rating => 3, :food_rating=> 1, :ambiance_rating=> 3, :value_rating=> 2, :noise_level=> 4, :body=>"I have been here several times before. Some of my favorite dishes are no longer available. The menu didn't match the one on their website. The chicken was a little dry. I had a satisfactory experience and will have to try it again.")
Review.create(:user_id => 32, :restaurant_id => 210, :overall_rating => 3, :food_rating=> 1, :ambiance_rating=> 4, :value_rating=> 2, :noise_level=> 4, :body=>"I'm torn about this place. The entree I had was sublime. The ambiance gives off an earthy feel-good vibe. Overall experience: 3 stars.")
Review.create(:user_id => 23, :restaurant_id => 211, :overall_rating => 3, :food_rating=> 1, :ambiance_rating=> 4, :value_rating=> 2, :noise_level=> 4, :body=>"I had high hopes for this place. I felt the prices were too high given the quality of the food. The service wasn't that good and the waiter was clueless. Might be back. Time will tell.")
Review.create(:user_id => 24, :restaurant_id => 212, :overall_rating => 3, :food_rating=> 1, :ambiance_rating=> 4, :value_rating=> 2, :noise_level=> 4, :body=>"This place had a lot of heart. Some of my favorite dishes are no longer available. The entree I had was sublime. I had a satisfactory experience and will have to try it again.")
Review.create(:user_id => 25, :restaurant_id => 213, :overall_rating => 3, :food_rating=> 5, :ambiance_rating=> 4, :value_rating=> 2, :noise_level=> 5, :body=>"I have been here several times before. Some of my favorite dishes are no longer available. The menu didn't match the one on their website. The chicken was a little dry. I had a satisfactory experience and will have to try it again.")
Review.create(:user_id => 26, :restaurant_id => 214, :overall_rating => 3, :food_rating=> 5, :ambiance_rating=> 4, :value_rating=> 1, :noise_level=> 5, :body=>"This place had a lot of heart. I was not very pleased to find out that the coffee wasn't fair trade. The menu didn't match the one on their website. There were a lot of interesting decorations on the walls. Satisfactory experience, will come again.")
Review.create(:user_id => 27, :restaurant_id => 215, :overall_rating => 3, :food_rating=> 5, :ambiance_rating=> 4, :value_rating=> 1, :noise_level=> 5, :body=>"I had high hopes for this place. I felt the prices were too high given the quality of the food. The service wasn't that good and the waiter was clueless. Might be back. Time will tell.")
Review.create(:user_id => 28, :restaurant_id => 216, :overall_rating => 3, :food_rating=> 5, :ambiance_rating=> 5, :value_rating=> 1, :noise_level=> 5, :body=>"I have been here several times before. Some of my favorite dishes are no longer available. The menu didn't match the one on their website. The chicken was a little dry. I had a satisfactory experience and will have to try it again.")
Review.create(:user_id => 29, :restaurant_id => 217, :overall_rating => 3, :food_rating=> 5, :ambiance_rating=> 5, :value_rating=> 1, :noise_level=> 5, :body=>"I'm torn about this place. The entree I had was sublime. The ambiance gives off an earthy feel-good vibe. Overall experience: 3 stars.")
Review.create(:user_id => 30, :restaurant_id => 218, :overall_rating => 3, :food_rating=> 4, :ambiance_rating=> 5, :value_rating=> 1, :noise_level=> 5, :body=>"This place had a lot of heart. I was not very pleased to find out that the coffee wasn't fair trade. The menu didn't match the one on their website. There were a lot of interesting decorations on the walls. Satisfactory experience, will come again.")
Review.create(:user_id => 31, :restaurant_id => 219, :overall_rating => 3, :food_rating=> 4, :ambiance_rating=> 5, :value_rating=> 2, :noise_level=> 1, :body=>"I have been here several times before. Some of my favorite dishes are no longer available. The menu didn't match the one on their website. The chicken was a little dry. I had a satisfactory experience and will have to try it again.")
Review.create(:user_id => 32, :restaurant_id =>220, :overall_rating => 3, :food_rating=> 4, :ambiance_rating=> 5, :value_rating=> 2, :noise_level=> 1, :body=>"I'm torn about this place. The entree I had was sublime. The ambiance gives off an earthy feel-good vibe. Overall experience: 3 stars.")

Review.create(:user_id => 23, :restaurant_id => 191, :overall_rating => 2, :food_rating => 5, :ambiance_rating => 5, :value_rating => 4, :noise_level => 4, :body => "Oh! My! God! So good! Everything from the starters to the entrees to the desserts meshed perfectly with my flavor-profile. The decor was unique and incredible. 5 stars!" )
Review.create(:user_id => 24, :restaurant_id => 192, :overall_rating => 2, :food_rating=> 4, :ambiance_rating=> 1, :value_rating=> 5, :noise_level=> 1, :body=>"Bleh. The photos of the food were appetizing and palpable, but didn't live up to the hype. The service wasn't that good and the waitress was tired. Meh.")
Review.create(:user_id => 25, :restaurant_id => 193, :overall_rating => 2, :food_rating=> 4, :ambiance_rating=> 1, :value_rating=> 5, :noise_level=> 1, :body=>"I am never coming back here! Overhyped. The food was all right but seriously lacked presentation. I would be hard pressed to come back.")
Review.create(:user_id => 26, :restaurant_id => 194, :overall_rating => 2, :food_rating=> 4, :ambiance_rating=> 1, :value_rating=> 5, :noise_level=> 1, :body=>"I felt like this place wasn't trying at all. The photos of the food were appetizing and palpable, but didn't live up to the hype. The service wasn't that good and the waiter was clueless. Too many things on the menu look like crap, smell like crap, and taste like crap. I shouldn't have to pay good money to be served vegetables from a can. They need to get their act together before I set foot in this place again.")
Review.create(:user_id => 27, :restaurant_id => 195, :overall_rating => 2, :food_rating=> 4, :ambiance_rating=> 1, :value_rating=> 5, :noise_level=> 1, :body=>"I am never coming back here! The waitress was barely there. Too many things on the menu look like crap, smell like crap, and taste like crap. The chicken was a little dry. The menu didn't match the one on their website. I gave this place two stars because I was feeling extra generous.")
Review.create(:user_id => 28, :restaurant_id => 196, :overall_rating => 2, :food_rating=> 3, :ambiance_rating=> 1, :value_rating=> 5, :noise_level=> 1, :body=>"I felt like this place wasn't trying at all. I found the entrees to not be very agreeable to my personal flavor-profile. Seriously, how difficult is it to get a clean glass around here? Meh.")
Review.create(:user_id => 29, :restaurant_id => 197, :overall_rating => 2, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 5, :noise_level=> 1, :body=>"Bleh. The photos of the food were appetizing and palpable, but didn't live up to the hype. The service wasn't that good and the waitress was tired. Meh.")
Review.create(:user_id => 30, :restaurant_id => 198, :overall_rating => 2, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 4, :noise_level=> 2, :body=>"I felt like this place wasn't trying at all. I found the entrees to not be very agreeable to my personal flavor-profile. Seriously, how difficult is it to get a clean glass around here? Meh.")
Review.create(:user_id => 31, :restaurant_id => 199, :overall_rating => 2, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 4, :noise_level=> 2, :body=>"I am never coming back here! The waitress was barely there. Too many things on the menu look like crap, smell like crap, and taste like crap. The chicken was a little dry. The menu didn't match the one on their website. I gave this place two stars because I was feeling extra generous.")
Review.create(:user_id => 32, :restaurant_id => 200, :overall_rating => 2, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 4, :noise_level=> 2, :body=>"I felt like this place wasn't trying at all. The photos of the food were appetizing and palpable, but didn't live up to the hype. The service wasn't that good and the waiter was clueless. Too many things on the menu look like crap, smell like crap, and taste like crap. I shouldn't have to pay good money to be served vegetables from a can. They need to get their act together before I set foot in this place again.")
Review.create(:user_id => 23, :restaurant_id => 201, :overall_rating => 2, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 4, :noise_level=> 2, :body=>"I felt like this place wasn't trying at all. I found the entrees to not be very agreeable to my personal flavor-profile. Seriously, how difficult is it to get a clean glass around here? Meh.")
Review.create(:user_id => 24, :restaurant_id => 202, :overall_rating => 2, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 4, :noise_level=> 2, :body=>"I am never coming back here! Overhyped. The food was all right but seriously lacked presentation. I would be hard pressed to come back.")
Review.create(:user_id => 25, :restaurant_id => 203, :overall_rating => 2, :food_rating=> 3, :ambiance_rating=> 3, :value_rating=> 4, :noise_level=> 3, :body=>"Bleh. The photos of the food were appetizing and palpable, but didn't live up to the hype. The service wasn't that good and the waitress was tired. Meh.")
Review.create(:user_id => 26, :restaurant_id => 204, :overall_rating => 2, :food_rating=> 2, :ambiance_rating=> 3, :value_rating=> 3, :noise_level=> 3, :body=>"I am never coming back here! The waitress was barely there. Too many things on the menu look like crap, smell like crap, and taste like crap. The chicken was a little dry. The menu didn't match the one on their website. I gave this place two stars because I was feeling extra generous.")
Review.create(:user_id => 27, :restaurant_id => 205, :overall_rating => 2, :food_rating=> 2, :ambiance_rating=> 3, :value_rating=> 3, :noise_level=> 3, :body=>"I felt like this place wasn't trying at all. The photos of the food were appetizing and palpable, but didn't live up to the hype. The service wasn't that good and the waiter was clueless. Too many things on the menu look like crap, smell like crap, and taste like crap. I shouldn't have to pay good money to be served vegetables from a can. They need to get their act together before I set foot in this place again.")
Review.create(:user_id => 28, :restaurant_id => 206, :overall_rating => 2, :food_rating=> 2, :ambiance_rating=> 3, :value_rating=> 3, :noise_level=> 3, :body=>"I am never coming back here! Overhyped. The food was all right but seriously lacked presentation. I would be hard pressed to come back.")
Review.create(:user_id => 29, :restaurant_id => 207, :overall_rating => 2, :food_rating=> 2, :ambiance_rating=> 3, :value_rating=> 3, :noise_level=> 3, :body=>"I felt like this place wasn't trying at all. I found the entrees to not be very agreeable to my personal flavor-profile. Seriously, how difficult is it to get a clean glass around here? Meh.")
Review.create(:user_id => 30, :restaurant_id => 208, :overall_rating => 2, :food_rating=> 1, :ambiance_rating=> 3, :value_rating=> 3, :noise_level=> 4, :body=>"Bleh. The photos of the food were appetizing and palpable, but didn't live up to the hype. The service wasn't that good and the waitress was tired. Meh.")
Review.create(:user_id => 31, :restaurant_id => 209, :overall_rating => 2, :food_rating=> 1, :ambiance_rating=> 3, :value_rating=> 2, :noise_level=> 4, :body=>"I really wanted to like this place. I shouldn't have to pay good money to be served vegetables from a can. Too many things on the menu look like crap, smell like crap, and taste like crap. I found the entrees to not be very agreeable to my personal flavor-profile. I had a less than satisfactory experience and will probably not be here again.")
Review.create(:user_id => 32, :restaurant_id => 210, :overall_rating => 2, :food_rating=> 1, :ambiance_rating=> 4, :value_rating=> 2, :noise_level=> 4, :body=>"I felt like this place wasn't trying at all. The photos of the food were appetizing and palpable, but didn't live up to the hype. The service wasn't that good and the waiter was clueless. Too many things on the menu look like crap, smell like crap, and taste like crap. I shouldn't have to pay good money to be served vegetables from a can. They need to get their act together before I set foot in this place again.")
Review.create(:user_id => 23, :restaurant_id => 211, :overall_rating => 2, :food_rating=> 1, :ambiance_rating=> 4, :value_rating=> 2, :noise_level=> 4, :body=>"I am never coming back here! Overhyped. The food was all right but seriously lacked presentation. I would be hard pressed to come back.")
Review.create(:user_id => 24, :restaurant_id => 212, :overall_rating => 2, :food_rating=> 1, :ambiance_rating=> 4, :value_rating=> 2, :noise_level=> 4, :body=>"I am never coming back here! The waitress was barely there. Too many things on the menu look like crap, smell like crap, and taste like crap. The chicken was a little dry. The menu didn't match the one on their website. I gave this place two stars because I was feeling extra generous.")
Review.create(:user_id => 25, :restaurant_id => 213, :overall_rating => 2, :food_rating=> 5, :ambiance_rating=> 4, :value_rating=> 2, :noise_level=> 5, :body=>"Bleh. The photos of the food were appetizing and palpable, but didn't live up to the hype. The service wasn't that good and the waitress was tired. Meh.")
Review.create(:user_id => 26, :restaurant_id => 214, :overall_rating => 2, :food_rating=> 5, :ambiance_rating=> 4, :value_rating=> 1, :noise_level=> 5, :body=>"I really wanted to like this place. I shouldn't have to pay good money to be served vegetables from a can. Too many things on the menu look like crap, smell like crap, and taste like crap. I found the entrees to not be very agreeable to my personal flavor-profile. I had a less than satisfactory experience and will probably not be here again.")
Review.create(:user_id => 27, :restaurant_id => 215, :overall_rating => 2, :food_rating=> 5, :ambiance_rating=> 4, :value_rating=> 1, :noise_level=> 5, :body=>"I felt like this place wasn't trying at all. The photos of the food were appetizing and palpable, but didn't live up to the hype. The service wasn't that good and the waiter was clueless. Too many things on the menu look like crap, smell like crap, and taste like crap. I shouldn't have to pay good money to be served vegetables from a can. They need to get their act together before I set foot in this place again.")
Review.create(:user_id => 28, :restaurant_id => 216, :overall_rating => 2, :food_rating=> 5, :ambiance_rating=> 5, :value_rating=> 1, :noise_level=> 5, :body=>"I am never coming back here! Overhyped. The food was all right but seriously lacked presentation. I would be hard pressed to come back.")
Review.create(:user_id => 29, :restaurant_id => 217, :overall_rating => 2, :food_rating=> 5, :ambiance_rating=> 5, :value_rating=> 1, :noise_level=> 5, :body=>"I am never coming back here! The waitress was barely there. Too many things on the menu look like crap, smell like crap, and taste like crap. The chicken was a little dry. The menu didn't match the one on their website. I gave this place two stars because I was feeling extra generous.")
Review.create(:user_id => 30, :restaurant_id => 218, :overall_rating => 2, :food_rating=> 4, :ambiance_rating=> 5, :value_rating=> 1, :noise_level=> 5, :body=>"Bleh. The photos of the food were appetizing and palpable, but didn't live up to the hype. The service wasn't that good and the waitress was tired. Meh.")
Review.create(:user_id => 31, :restaurant_id => 219, :overall_rating => 2, :food_rating=> 4, :ambiance_rating=> 5, :value_rating=> 2, :noise_level=> 1, :body=>"I felt like this place wasn't trying at all. The photos of the food were appetizing and palpable, but didn't live up to the hype. The service wasn't that good and the waiter was clueless. Too many things on the menu look like crap, smell like crap, and taste like crap. I shouldn't have to pay good money to be served vegetables from a can. They need to get their act together before I set foot in this place again.")
Review.create(:user_id => 32, :restaurant_id => 220, :overall_rating => 2, :food_rating=> 4, :ambiance_rating=> 5, :value_rating=> 2, :noise_level=> 1, :body=>"I am never coming back here! Overhyped. The food was all right but seriously lacked presentation. I would be hard pressed to come back.")

Review.create(:user_id => 23, :restaurant_id => 191, :overall_rating => 1, :food_rating => 5, :ambiance_rating => 5, :value_rating => 4, :noise_level => 4, :body => "Oh! My! God! So good! Everything from the starters to the entrees to the desserts meshed perfectly with my flavor-profile. The decor was unique and incredible. 5 stars!" )
Review.create(:user_id => 24, :restaurant_id => 192, :overall_rating => 1, :food_rating=> 4, :ambiance_rating=> 1, :value_rating=> 5, :noise_level=> 1, :body=>"I can summarize my visit in one word: Dreadful. The whole place was just dirty. The kitchen screwed up my order completely, mixing it up with someone else's. It took almost an hour to get it corrected! Overhyped. Seriously, how difficult is it to get a clean glass around here? 1 star was too generous.")
Review.create(:user_id => 25, :restaurant_id => 193, :overall_rating => 1, :food_rating=> 4, :ambiance_rating=> 1, :value_rating=> 5, :noise_level=> 1, :body=>"Dreadful place. I found a dead cockroach on the floor of my booth. They can survive a nuclear explosion, but the entree was too much for them. I threw up in my mouth a little when they brought me my food. Overhyped. I found an eyelash that definitely wasn't mine in my food. Wild horses couldn't drag me back here.")
Review.create(:user_id => 26, :restaurant_id => 194, :overall_rating => 1, :food_rating=> 4, :ambiance_rating=> 1, :value_rating=> 5, :noise_level=> 1, :body=>"Yuck! I found an eyelash that definitely wasn't mine in my food. Too many things on the menu look like crap, smell like crap, and taste like crap. Wild horses couldn't drag me back here.")
Review.create(:user_id => 27, :restaurant_id => 195, :overall_rating => 1, :food_rating=> 4, :ambiance_rating=> 1, :value_rating=> 5, :noise_level=> 1, :body=>"Worst experience ever! Even Chef Boyardee would be disgusted by this sorry attempt at a meal. I heard a rumor that the vegetarian dishes are prepared alongside the meat. I think this place was featured on Kitchen Nightmares, or at least it should have been. I wish I could put a sign out front that said. DONT EAT HERE!")
...
Review.create(:user_id => 29, :restaurant_id => 197, :overall_rating => 1, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 5, :noise_level=> 1, :body=>"I can summarize my visit in one word: Dreadful. The whole place was just dirty. The kitchen screwed up my order completely, mixing it up with someone elses. It took almost an hour to get it corrected! Overhyped. Seriously, how difficult is it to get a clean glass around here? 1 star was too generous.")
Review.create(:user_id => 30, :restaurant_id => 198, :overall_rating => 1, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 4, :noise_level=> 2, :body=>"I can summarize my visit in one word: Horrible. The kitchen screwed up my order completely, mixing it up with someone else's. It took almost an hour to get it corrected! I asked for my steak medium, but it was frozen in the center. The dead flies on the window sill indicated to me that they don't do a good job cleaning and the flies found the food to be toxic. I gave 1 star because I couldn't give 0.")
Review.create(:user_id => 31, :restaurant_id => 199, :overall_rating => 1, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 4, :noise_level=> 2, :body=>"Lame. The kitchen screwed up my order completely, mixing it up with someone else's. It took almost an hour to get it corrected! Overhyped. This food will start the zombie apocalypse. Stay away!")
Review.create(:user_id => 32, :restaurant_id => 200, :overall_rating => 1, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 4, :noise_level=> 2, :body=>"Yuck! I found an eyelash that definitely wasn't mine in my food. Too many things on the menu look like crap, smell like crap, and taste like crap. Wild horses couldn't drag me back here.")
Review.create(:user_id => 23, :restaurant_id => 201, :overall_rating => 1, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 4, :noise_level=> 2, :body=>"Dreadful place. I found a dead cockroach on the floor of my booth. They can survive a nuclear explosion, but the entree was too much for them. I threw up in my mouth a little when they brought me my food. Overhyped. I found an eyelash that definitely wasn't mine in my food. Wild horses couldn't drag me back here.")
Review.create(:user_id => 24, :restaurant_id => 202, :overall_rating => 1, :food_rating=> 3, :ambiance_rating=> 2, :value_rating=> 4, :noise_level=> 2, :body=>"Worst experience ever! Even Chef Boyardee would be disgusted by this sorry attempt at a meal. I heard a rumor that the vegetarian dishes are prepared alongside the meat. I think this place was featured on Kitchen Nightmares, or at least it should have been. I wish I could put a sign out front that said DONT EAT HERE!")
Review.create(:user_id => 25, :restaurant_id => 203, :overall_rating => 1, :food_rating=> 3, :ambiance_rating=> 3, :value_rating=> 4, :noise_level=> 3, :body=>"I can summarize my visit in one word: Dreadful. The whole place was just dirty. The kitchen screwed up my order completely, mixing it up with someone elses. It took almost an hour to get it corrected! Overhyped. Seriously, how difficult is it to get a clean glass around here? 1 star was too generous.")
Review.create(:user_id => 26, :restaurant_id => 204, :overall_rating => 1, :food_rating=> 2, :ambiance_rating=> 3, :value_rating=> 3, :noise_level=> 3, :body=>"I felt like this place wasnt trying at all. Eating here is like playing Russian Roulette, only you have a 5 out of 6 chance of getting food poisoning. Overhyped. The kitchen screwed up my order completely, mixing it up with someone elses. It took almost an hour to get it corrected! 1 star. Never again.")
Review.create(:user_id => 27, :restaurant_id => 205, :overall_rating => 1, :food_rating=> 2, :ambiance_rating=> 3, :value_rating=> 3, :noise_level=> 3, :body=>"I can summarize my visit in one word: Horrible. The kitchen screwed up my order completely, mixing it up with someone else's. It took almost an hour to get it corrected! I asked for my steak medium, but it was frozen in the center. The dead flies on the window sill indicated to me that they don't do a good job cleaning and the flies found the food to be toxic. I gave 1 star because I couldn't give 0.")
Review.create(:user_id => 28, :restaurant_id => 206, :overall_rating => 1, :food_rating=> 2, :ambiance_rating=> 3, :value_rating=> 3, :noise_level=> 3, :body=>"Yuck! I found an eyelash that definitely wasn't mine in my food. Too many things on the menu look like crap, smell like crap, and taste like crap. Wild horses couldn't drag me back here.")
Review.create(:user_id => 29, :restaurant_id => 207, :overall_rating => 1, :food_rating=> 2, :ambiance_rating=> 3, :value_rating=> 3, :noise_level=> 3, :body=>"I can summarize my visit in one word: Dreadful. The whole place was just dirty. The kitchen screwed up my order completely, mixing it up with someone else's. It took almost an hour to get it corrected! Overhyped. Seriously, how difficult is it to get a clean glass around here? 1 star was too generous.")
Review.create(:user_id => 30, :restaurant_id => 208, :overall_rating => 1, :food_rating=> 1, :ambiance_rating=> 3, :value_rating=> 3, :noise_level=> 4, :body=>"Lame. The kitchen screwed up my order completely, mixing it up with someone else's. It took almost an hour to get it corrected! Overhyped. This food will start the zombie apocalypse. Stay away!")
Review.create(:user_id => 31, :restaurant_id => 209, :overall_rating => 1, :food_rating=> 1, :ambiance_rating=> 3, :value_rating=> 2, :noise_level=> 4, :body=>"I felt like this place wasn't trying at all. Eating here is like playing Russian Roulette, only you have a 5 out of 6 chance of getting food poisoning. Overhyped. The kitchen screwed up my order completely, mixing it up with someone else's. It took almost an hour to get it corrected! 1 star. Never again.")
Review.create(:user_id => 32, :restaurant_id => 210, :overall_rating => 1, :food_rating=> 1, :ambiance_rating=> 4, :value_rating=> 2, :noise_level=> 4, :body=>"Yuck! I found an eyelash that definitely wasn't mine in my food. Too many things on the menu look like crap, smell like crap, and taste like crap. Wild horses couldn't drag me back here.")
Review.create(:user_id => 23, :restaurant_id => 211, :overall_rating => 1, :food_rating=> 1, :ambiance_rating=> 4, :value_rating=> 2, :noise_level=> 4, :body=>"I felt like this place wasn't trying at all. Eating here is like playing Russian Roulette, only you have a 5 out of 6 chance of getting food poisoning. Overhyped. The kitchen screwed up my order completely, mixing it up with someone else's. It took almost an hour to get it corrected! 1 star. Never again.")
Review.create(:user_id => 24, :restaurant_id => 212, :overall_rating => 1, :food_rating=> 1, :ambiance_rating=> 4, :value_rating=> 2, :noise_level=> 4, :body=>"Dreadful place. I found a dead cockroach on the floor of my booth. They can survive a nuclear explosion, but the entree was too much for them. I threw up in my mouth a little when they brought me my food. Overhyped. I found an eyelash that definitely wasn't mine in my food. Wild horses couldn't drag me back here.")
Review.create(:user_id => 25, :restaurant_id => 213, :overall_rating => 1, :food_rating=> 5, :ambiance_rating=> 4, :value_rating=> 2, :noise_level=> 5, :body=>"I can summarize my visit in one word: Horrible. The kitchen screwed up my order completely, mixing it up with someone else's. It took almost an hour to get it corrected! I asked for my steak medium, but it was frozen in the center. The dead flies on the window sill indicated to me that they don't do a good job cleaning and the flies found the food to be toxic. I gave 1 star because I couldn't give 0.")
Review.create(:user_id => 26, :restaurant_id => 214, :overall_rating => 1, :food_rating=> 5, :ambiance_rating=> 4, :value_rating=> 1, :noise_level=> 5, :body=>"Worst experience ever! Even Chef Boyardee would be disgusted by this sorry attempt at a meal. I heard a rumor that the vegetarian dishes are prepared alongside the meat. I think this place was featured on Kitchen Nightmares, or at least it should have been. I wish I could put a sign out front that said DON'T EAT HERE!")
Review.create(:user_id => 27, :restaurant_id => 215, :overall_rating => 1, :food_rating=> 5, :ambiance_rating=> 4, :value_rating=> 1, :noise_level=> 5, :body=>"I can summarize my visit in one word: Dreadful. The whole place was just dirty. The kitchen screwed up my order completely, mixing it up with someone else's. It took almost an hour to get it corrected! Overhyped. Seriously, how difficult is it to get a clean glass around here? 1 star was too generous.")
Review.create(:user_id => 28, :restaurant_id => 216, :overall_rating => 1, :food_rating=> 5, :ambiance_rating=> 5, :value_rating=> 1, :noise_level=> 5, :body=>"I can summarize my visit in one word: Horrible. The kitchen screwed up my order completely, mixing it up with someone else's. It took almost an hour to get it corrected! I asked for my steak medium, but it was frozen in the center. The dead flies on the window sill indicated to me that they don't do a good job cleaning and the flies found the food to be toxic. I gave 1 star because I couldn't give 0.")
Review.create(:user_id => 29, :restaurant_id => 217, :overall_rating => 1, :food_rating=> 5, :ambiance_rating=> 5, :value_rating=> 1, :noise_level=> 5, :body=>"Yuck! I found an eyelash that definitely wasn't mine in my food. Too many things on the menu look like crap, smell like crap, and taste like crap. Wild horses couldn't drag me back here.")
Review.create(:user_id => 30, :restaurant_id => 218, :overall_rating => 1, :food_rating=> 4, :ambiance_rating=> 5, :value_rating=> 1, :noise_level=> 5, :body=>"Worst experience ever! Even Chef Boyardee would be disgusted by this sorry attempt at a meal. I heard a rumor that the vegetarian dishes are prepared alongside the meat. I think this place was featured on Kitchen Nightmares, or at least it should have been. I wish I could put a sign out front that said DON'T EAT HERE!")
Review.create(:user_id => 31, :restaurant_id => 219, :overall_rating => 1, :food_rating=> 4, :ambiance_rating=> 5, :value_rating=> 2, :noise_level=> 1, :body=>"Dreadful place. I found a dead cockroach on the floor of my booth. They can survive a nuclear explosion, but the entree was too much for them. I threw up in my mouth a little when they brought me my food. Overhyped. I found an eyelash that definitely wasn't mine in my food. Wild horses couldn't drag me back here.")
Review.create(:user_id => 32, :restaurant_id => 220, :overall_rating => 1, :food_rating=> 4, :ambiance_rating=> 5, :value_rating=> 2, :noise_level=> 1, :body=>"I can summarize my visit in one word: Dreadful. The whole place was just dirty. The kitchen screwed up my order completely, mixing it up with someone else's. It took almost an hour to get it corrected! Overhyped. Seriously, how difficult is it to get a clean glass around here? 1 star was too generous.")
...
User.create(first_name: "Larry", last_name: "Rekrap", username: "LRekrap", email: "demo.user1@ymail.com", password: "password", phone_number: "555-445-4656")
User.create(first_name: "Denise", last_name: "Rekrap", username: "DRekrap", email: "demo.user2@ymail.com", password: "password", phone_number: "555-357-8858")
User.create(first_name: "Vesha", last_name: "Rekrap", username: "VRekrap", email: "demo.user3@ymail.com", password: "password", phone_number: "555-674-6466")
User.create(first_name: "Vinia", last_name: "Rekrap", username: "VRekrap1", email: "demo.user4@ymail.com", password: "password", phone_number: "555-246-3465")
User.create(first_name: "Brittany", last_name: "Rehcturc", username: "BRehcturc", email: "demo.user5@ymail.com", password: "password", phone_number: "555-786-5686")
User.create(first_name: "Adele", last_name: "Sdnomde", username: "ASdnomde", email: "demo.user6@ymail.com", password: "password", phone_number: "555-246-6464")
User.create(first_name: "Elsa", last_name: "Noeled", username: "ENoled", email: "demo.user7@ymail.com", password: "password", phone_number: "555-678-2343")
User.create(first_name: "Mema", last_name: "Coleman", username: "MCole", email: "demo.user8@ymail.com", password: "password", phone_number: "555-257-5775")
User.create(first_name: "Pepa", last_name: "Coleman", username: "PCole", email: "demo.user9@ymail.com", password: "password", phone_number: "555-754-3637")
